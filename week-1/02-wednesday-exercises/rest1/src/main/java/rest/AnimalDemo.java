...
public class AnimalDemo {
    ...
    public AnimalDemo() {
        if(animals.isEmpty()) {
            ...
            AnimalNoDB a2 = new AnimalNoDB("Cat", "Mijau");
            AnimalNoDB a3 = new AnimalNoDB("Snake", "Sss");
            animals.add(a1);
            animals.add(a2);
            animals.add(a3);
        }
    ...
    public String getJson3() {
        //TODO return proper representation object
        AnimalNoDB animal = new AnimalNoDB("Tiger", "Wraaah");
        String jsonString = new Gson().toJson(animal);
        return jsonString;
    }
